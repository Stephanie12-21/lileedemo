  ...
  return (
    <div className="relative p-8">
      <div className="flex justify-between items-center ">
        ...
        <Menu
          onClick={toggleMenu}
          className="absolute text-muted h-8 w-8 hidden max-md:block z-50 right-8
          cursor-pointer"
        />
...
function NavMob({ toggleMenu }) {
  const path = usePathname();
  return (
    <div className="z-10 left-0 absolute top-0 right-0 w-full  min-h-screen h-full bg-[#15213d] transform translate-y-0">
