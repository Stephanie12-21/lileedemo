...
const PubliciteForm = () => {
 ...
 // const [videoPub, setVideoPub] = useState([]);
  ...
  //   setVideoPub((prevVideos) => [...prevVideos, ...files]);
  // };

  // const handleRemoveVideo = (index) => {
  //   setVideoPub((prevVideos) => prevVideos.filter((_, i) => i !== index));
  // };
  ...
  return (
    <div className="max-w-7xl m-10 p-6 bg-white shadow-md my-5 rounded-lg">
      ...
      {step === 2 && (
        <div className="flex-col space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="space-y-3">
                <Label htmlFor="images">Images publicitaires:</Label>
                <Input
                  type="file"
                  id="images"
              ...
              {/* <div className="space-y-3">
                <Label htmlFor="videos">Vidéos publicitaires:</Label>
                <Input
                  type="file"
                  id="videos"
