...
const Annonces = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      content:
        "La dernière étape consiste à fournir vos informations professionnelles et bancaires et valider l'ensemble des informations. Une fois cette étape complétée, vous pourrez commencer à recevoir des paiements en toute sécurité.",
    },
  ];
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 justify-between mb-8">
        ...
        <Link href="/professionnel/annonces/addAnnonce">
            ...
            >
              ...
              <CardFooter className="flex flex-col p-4 h-full">
                ...
                <div className="flex justify-between items-center w-full pt-8 mt-auto">
                  <Link
                    href={`/professionnel/annonces/id=${annonce.id}`}
                  ...
                  <Link
                    href={`/professionnel/annonces/editAnnonce/id=${annonce.id}`}
